    ...
    public void create () {
        ...
        world.setContactListener(new ContactListener() {
            ...
            public void beginContact(Contact contact) {
                // Is the collission between the second sprite and the bottom of the screen?
                // If so apply an upward force.
                if ((contact.getFixtureA().getBody() == bodyEdgeScreen &&
                    ...
                    body1.applyForceToCenter(0, MathUtils.random(20, 50), true);
